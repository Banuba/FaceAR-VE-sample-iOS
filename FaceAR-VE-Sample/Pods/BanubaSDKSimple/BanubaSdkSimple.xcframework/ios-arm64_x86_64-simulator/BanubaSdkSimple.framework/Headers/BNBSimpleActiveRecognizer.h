...
@class BNBSimpleActiveRecognizer;


@interface BNBSimpleActiveRecognizer : NSObject

+ (nullable BNBSimpleActiveRecognizer *)create;

- (void)setFeatures:(BNBSimpleFeaturesFlags)features;
...
- (void)pushCameraFrame:(nullable BNBSimpleFrameData *)inputFrameData;

- (BOOL)popFrameData:(nullable BNBSimpleFrameData *)outputFrameData;
