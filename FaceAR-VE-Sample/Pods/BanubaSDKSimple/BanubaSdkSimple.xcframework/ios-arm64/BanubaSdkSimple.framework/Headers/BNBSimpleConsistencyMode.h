 ...
 */
typedef NS_ENUM(NSInteger, BNBSimpleConsistencyMode)
{
    BNBSimpleConsistencyModeSynchronous,
    /**switches to async-inconsistent mode while no faces are to be found */
    BNBSimpleConsistencyModeDefaultSynchronousWhenTracking,
    BNBSimpleConsistencyModeAsynchronousInconsistent,
    BNBSimpleConsistencyModeAsynchronousConsistent,
};
