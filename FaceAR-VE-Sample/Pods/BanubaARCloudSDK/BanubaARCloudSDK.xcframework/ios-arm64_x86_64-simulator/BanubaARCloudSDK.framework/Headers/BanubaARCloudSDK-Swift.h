...
#ifndef BANUBAARCLOUDSDK_SWIFT_H
#define BANUBAARCLOUDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BanubaARCloudSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP16BanubaARCloudSDK8AREffect_")
@protocol AREffect
