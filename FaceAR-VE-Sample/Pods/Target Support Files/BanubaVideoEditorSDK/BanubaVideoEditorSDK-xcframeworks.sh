...
install_xcframework "${PODS_ROOT}/BanubaVideoEditorSDK/BanubaVideoEditorSDK.xcframework" "BanubaVideoEditorSDK" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
